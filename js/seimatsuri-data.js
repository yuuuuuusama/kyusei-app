...
(function (global) {
  ...
  const SEIMATSURI_DATA = [
    { star: '月星',   period: '進運期', text: '忍耐を守って焦らず時を待つべし！' },
    { star: '火曜星', period: '大運期', text: '堅実に物事を進めれば願望成就の年。ただし、多くを望むべからず！' },
    { star: '水曜星', period: '大運期', text: '努力が報われる年。ただ、自分の短所が出てしまう年でもあるので注意！' },
    { star: '木曜星', period: '楽運期', text: 'すべて順調であり、人の助けも得られる。注意に注意！油断は禁物！' },
    { star: '金曜星', period: '暗運期', text: '何事もつまずき、多難な年。特に金銭は注意！信心にて克服を年。' },
    { star: '土曜星', period: '焦運期', text: '力強く前進の年。しかし、焦りは禁物！後半までゆっくりと！' },
    { star: '日曜星', period: '幸運期', text: '何事も思い通りで家庭も円満、喜び舞い込む年。時期を待つべし！後半は注意！' },
    { star: '羅喉星', period: '陰運期', text: '諸事順調で結果になる年難。盗難に注意。' },
    { star: '計都星', period: '病運期', text: '病気や迷いが多く、不運な年。現状維持に努力すべし！' }
  ];
  ...
  // 1: 月星 (進運期)  2: 火曜星  3: 水曜星  4: 木曜星  5: 金曜星
